        ...
        <View style={{ flex: 1, backgroundColor: '#f7f7f7' }}>
            <View>
                ...
                <CalendarStrip
                    ...
                    style={{
                        top: 0, marginTop: 0, marginBottom: 5, borderColor: '#BEBEBE', borderWidth: .5, paddingVertical: 10
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    if (mediaType == "image") {
                        mediaComponent = <Image style={styles.postImage} source={{ uri: item.media }} resizeMode="cover" />
                    }
